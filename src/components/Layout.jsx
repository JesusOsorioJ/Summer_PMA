          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link
                ...
                className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group
                  ${view == "ResultadosGanadores" && "bg-gray-100 dark:bg-gray-700"}
                  `}
              >
                <svg
                  className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
          ...
          <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
            ...
            <li>
              <Link
                ...
                className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group
                  ${view == "AdminConfigLoterias" && "bg-gray-100 dark:bg-gray-700"}
                  `}
              >
                <svg
                  className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            <li>
              <Link
                ...
                className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group
                  ${view == "AdminGestionVentasPagos" && "bg-gray-100 dark:bg-gray-700"}
                  `}
              >
                <svg
                  className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            <li>
              <Link
                ...
                className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group
                  ${view == "AdminReportesBalance" && "bg-gray-100 dark:bg-gray-700"}
                  `}
              >
                <svg
                  className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            <li>
              <Link
                ...
                className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group
                  ${view == "AdminRegistroTransacciones" && "bg-gray-100 dark:bg-gray-700"}
                  `}
              >
                <svg
                  className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
